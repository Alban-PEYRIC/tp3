...
public class PropertyExample {
    private ChangeListener changeListener = ((observable, oldValue, newValue) -> System.out.println("The observableValue has changed"+ oldValue +","+ newValue));

    private InvalidationListener invalidationListener = observable -> { System.out.println("The observableValue has been invalited.");
    };
    ...
    void addAndRemoveChangeListener() {
        ...
        System.out.println("set() with 5012.");
        anIntProperty.setValue(5012);
